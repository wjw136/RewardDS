...
from Dataset.finqa_dataset import SingleR_noBack_Dataset_noR, collate_fn_noBack_noR
import time
...
def main(args):
    ...
    with torch.no_grad():
        for idx, batch_data in enumerate(tqdm(test_dataloader)):
            input_prompts, questions = batch_data['input_prompts'], batch_data['questions']
...
if __name__ == '__main__':
    ...
    parser.add_argument("--is_gready", type=str2bool, default=False, help='model name')
